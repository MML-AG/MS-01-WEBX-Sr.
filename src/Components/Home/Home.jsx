...
<div className="w-full h-[100vh] font-generica font-semibold text-center" >
                ...
                <div className='w-full h-full pt-[10vh] flex justify-center items-center flex-col gap-10'>
                    <Image draggable={false} src={base + 'logoNT.png'} width={450} className='' />
                    <h1 className="text-5xl">GROW<span className='text-6xl'>.</span> GREEN<span className='text-6xl'>.</span> GLOBAL<span className='text-6xl'>.</span></h1>
                </div>
            </div>

      {/* <div className="w-full h-[90vh] flex justify-center items-center z-10 font-generica font-semibold text-center " style={{ backgroundImage:`url(${image})`, backgroundRepeat:'no-repeat', backgroundSize: 'cover' }}>
        <h1 className="text-5xl">
          GROW <span className="text-6xl">.</span> GREEN
          <span className="text-6xl">.</span> GLOBAL.
        </h1>
      </div> */}
        ...
        <Card className="max-w-[80%]">
          ...
          <CardBody>
            <p className=" w-full flex text-sm md:text-lg lg:text-xl pl-4">
              ...
              promoting sustainable development practices within our community
              and beyond. We are committed to fostering a greener future by
              implementing initiatives that reduce carbon footprints, promote
              recycling, and enhance green spaces. .
              <br />
              <br />
              Through collaborative efforts and community engagement, we aim to
              raise awareness about environmental issues and inspire actionable
              steps towards sustainability. Our initiatives are designed to not
              only mitigate environmental impact but also to create lasting
              benefits for current and future generations. We believe in the
              power of education and empowerment. By educating our community
              about the importance of sustainable living and providing practical
              solutions, we encourage individuals and businesses to adopt
              eco-friendly practices in their daily lives and operations.
              <br />
              <br />
              From organizing local clean-up drives to advocating for renewable
              energy solutions, our projects are diverse and impactful. We work
              closely with local authorities, businesses, and volunteers to
              ensure our efforts are aligned with broader environmental goals
              and contribute positively to our surroundings. Join us in our
              journey towards a healthier planet and a more resilient community.
              Together, we can make a significant difference in preserving our
              natural resources and building a sustainable future for all.
              <br />
              <br />
            </p>
          </CardBody>
                      ...
                      <CardBody>
                        ...
                        <div className="flex justify-center">
                          <p className="w-full flex justify-center items-center font-code text-xs font-bold text-n-1 uppercase tracking-wider p-3">
                           <Button  onClick={() => navigate(`/Events`)}> Explore more <Arrow /> </Button> 
                          </p>
                        </div>
                      </CardBody>
                    </Card>
